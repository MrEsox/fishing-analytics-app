...
<template>
  <div class="min-h-screen bg-black flex justify-center items-center relative overflow-hidden">
    <!-- Background glow -->
    <div class="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(16,185,129,0.15),transparent_40%),radial-gradient(circle_at_80%_80%,rgba(59,130,246,0.15),transparent_40%)] animate-pulse" />
